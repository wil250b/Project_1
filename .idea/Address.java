...
public class Address {
     ...
     * @param postalCode to check
     * @return true or false whether it postal code is valid
     */
    public boolean isPostalCodeValid(String postalCode) {
        ...
        //    validOrNot = false;
        //} else {
        if(postalCode.length() == 6) { // length of six
            ...
            boolean check4 = (Character.isLetter(postalCode.charAt(1))); //numbers
        ...
        } else if (postalCode.length() == 7) { //length of seven
